...
var CalendarDay = function (_Component) {
  (0, _inherits3.default)(CalendarDay, _Component);
  ...
  function CalendarDay() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CalendarDay.__proto__ || (0, _getPrototypeOf2.default)(CalendarDay)).call.apply(_ref, [this].concat(args))), _this), _this.handleClickDay = function (event, date) {
